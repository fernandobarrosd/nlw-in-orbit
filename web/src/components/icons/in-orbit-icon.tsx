export function InOrbitIcon() {
    return (
      ...
      <path
        ...
        fill="url(#paint0_linear_4008_188)"
      />
      <path
      ...
      <path
        ...
        fill="url(#paint1_linear_4008_188)"
      />
      <path
